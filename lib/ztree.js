...
var ReactZtree = function (_PureComponent) {
    ...
    _createClass(ReactZtree, [{
        ...
        value: function componentDidMount() {
            ...
            function addFolder(parentNode) {
                ...
                if (parentNode) {
                    ...
                    inputObj.bind('blur', function (event) {
                        newfolder.name = (0, _jquery2.default)(this).val();
                        ...
                        (0, _jquery2.default)(this).parent().html(newfolder.name);
                    }).bind('keydown', function (event) {
                        if (event.keyCode === 13 || event.keyCode === 27) {
                            newfolder.name = (0, _jquery2.default)(this).val();
                            if (newfolder.name.length === 0) {
        ...
        value: function exeConfigureAddFile(parentNode, newfile, oldpath, configure) {
        ...
        value: function exeConfigureRename(oldsource, node, oldpath, oldname, configure) {
